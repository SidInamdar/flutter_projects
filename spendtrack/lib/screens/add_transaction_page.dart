...
class _AddTransactionPageState extends State<AddTransactionPage> {
  ...
  Future<void> _fetchRecurringSuggestions() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Could not load suggestions: $e"), backgroundColor: Colors.orange),
      );
    }
  }
  ...
  Future<void> _submitTransaction() async {
    if (_formKey.currentState!.validate()) {
      ...
      final newTransaction = TransactionModel(
        // id will be generated by Firebase, so not passed here
        amount: amount,
      ...
      try {
        ...
        if (firebaseKey != null) {
          ...
          _fetchRecurringSuggestions(); // Refresh suggestions
          if (mounted && Navigator.canPop(context)) {
            Navigator.pop(context, true); // Signal success to list page
          }
        } else {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Failed to save transaction. No key returned.'), backgroundColor: Colors.red),
          );
        }
      } catch (e) {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget _buildSuggestions() {
    // ... (This widget's internal logic remains the same, using recurrenceCount for avatar)
  ...
  Widget build(BuildContext context) {
    // ... (The build method for the form itself remains largely the same)
    return Scaffold(
      appBar: AppBar(
          ...
          child: ListView(
            children: <Widget>[
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'Amount*', border: const OutlineInputBorder(), prefixIcon: Text(_indianRupeeSymbol, style: TextStyle(fontSize: 24, color: Theme.of(context).iconTheme.color))),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Tags (Optional)', border: OutlineInputBorder(), prefixIcon: Icon(Icons.label)),
              ),
              const SizedBox(height: 24),
              ElevatedButton(
